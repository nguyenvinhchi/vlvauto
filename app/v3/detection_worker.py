...
class DetectionWorker(GameTabIterate, QObject):
    ...
    def __init__(self, settings: QSettings):
        ...
        self.game_scenarios = [
            ShopOpenGameScenario(settings),
            BagOpenGameScenario(settings),
            AutoOffGameScenario(settings),
            TownStuckGameScenario(settings),
            UserPassLoginScenario(settings),
